...
public class ForeseeConstants {
    ...
    public static final String OPERATION_SUCCESS_FILE = "operationSuccessLog.csv";
    ...
    public static final String URL_SUFFIX_GROUPS = "/api/v1/groups/";
    public static final String URL_SUFFIX_RESET_PASSWORD = "/lifecycle/reset_password?sendEmail=false";
    ...
    public static final String USER_ID_LOG_FILE = "userIdLog.csv";
    public static final String USER_SAVE_SUCCESS_FILE = "userSaveSuccess.csv";
